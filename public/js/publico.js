...
socket.on('atender-ultimos', (ultimosTickets) => {

    //en firefox funciona habilitando permisos en el host
    const audio = new Audio('./audio/new-ticket.mp3');
    audio.play();

    //console.log(ultimosTickets); ultimos 4 tickets
    const [ ticket1, ticket2, ticket3, ticket4 ] = ultimosTickets;
    
    //verificar que vengan los tickets en mi array (pueden no venir porque no hay pendientes)
